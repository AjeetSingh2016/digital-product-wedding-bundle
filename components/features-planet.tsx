            ...
            <div className="text-center">
              <div className="relative inline-flex rounded-full before:absolute before:inset-0 before:-z-10 before:scale-[.85] before:animate-[pulse_4s_cubic-bezier(.4,0,.6,1)_infinite] before:bg-gradient-to-b before:from-blue-900 before:to-sky-700/50 before:blur-3xl after:absolute after:inset-0 after:rounded-[inherit] after:[background:radial-gradient(closest-side,theme(colors.blue.500),transparent)]">
                ...
                <div className="pointer-events-none" aria-hidden="true">
                  ...
                  <div>
                    <Image
                      className="absolute -left-10 top-16 z-10 animate-[float_4s_ease-in-out_infinite_both] opacity-40  transition-opacity duration-500"
                      src={PlanetTagImg01}
                      width={100}
                      height={56}
                      alt="Tag 01"
                    />
                    <Image
                      className="absolute left-60 top-7 z-10 animate-[float_4s_ease-in-out_infinite_1s_both] opacity-40 transition-opacity duration-500"
                      src={PlanetTagImg02}
                      width={100}
                      height={56}
                      alt="Tag 02"
                    />
                    <Image
                      className="absolute -left-10 bottom-1 z-10 animate-[float_4s_ease-in-out_infinite_2s_both] opacity-40 transition-opacity duration-500"
                      src={PlanetTagImg03}
                      width={100}
                      height={56}
                      alt="Tag 03"
                    />
                    <Image
                      className="absolute bottom-5 left-64 z-10 animate-[float_4s_ease-in-out_infinite_3s_both] opacity-40 transition-opacity duration-500"
                      src={PlanetTagImg04}
                      width={100}
                      height={56}
                      alt="Tag 04"
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-gray-800 [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Over 150+ resources</span>
              </h3>
              <p className="text-[15px] text-gray-400">
              Comprehensive including Lightroom presets, Photoshop actions, translations, 300+ wedding tracks and more.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
              Instant download and lifetime access upon purchase.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
            ...
            <article>
              ...
              <p className="text-[15px] text-gray-400">
              Works seamlessly with popular software like Lightroom, Photoshop, Premiere Pro, After Effects, and more.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
              High-quality, customizable templates and presets tailored for wedding projects.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Proven Satisfaction</span>
              </h3>
              <p className="text-[15px] text-gray-400">
              Trusted by over 5000 users with a 9.6 out of 10 rating from 3546+ reviews.
              </p>
            </article>

            {/* <a
                    className="p-2 px-8 btn group mt-5 mb-4 w-full bg-gradient-to-t from-blue-600 to-blue-500 bg-[length:100%_100%] bg-[bottom] text-white rounded shadow hover:bg-[length:100%_150%] sm:mb-0 sm:w-auto"
                    href="#0"
                  >
